...
def MapRelation(session1_datetime):
  ...
  for i in range(0, len(objects)):
    for j in range(0, len(objects)):
      orderedObjects = CompareObjects(objects[i], objects[j])
      ...
      relations[orderedObjects[0].Label][orderedObjects[1].Label] = ObjectRelations.ObjectRelations(distance, ClockDirection(point_1, point_2))
